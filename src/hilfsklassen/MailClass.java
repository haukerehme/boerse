...
public class MailClass {
    ...
    public static MailClass getInstance() {
        return MailClassHolder.INSTANCE;
    }
    
    private static class MailClassHolder {

        private static final MailClass INSTANCE = new MailClass();
    }
